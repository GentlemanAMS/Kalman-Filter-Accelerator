...
void matrix_initialization(DTYPE tempmat[MEASUREMENT_DIM][2*MEASUREMENT_DIM], DTYPE a[MEASUREMENT_DIM*MEASUREMENT_DIM]);

void normalization_copyback(DTYPE tempmat[MEASUREMENT_DIM][2*MEASUREMENT_DIM], DTYPE *res);
